...
$posts = mysqli_query($conn, "SELECT *, posts.created_at FROM posts INNER JOIN categorys ON posts.category_id = categorys.id WHERE slug = '$id'");
...
<body>
    ...
    <nav class="navbar navbar-expand-lg bg-light">
        <div class="container-fluid">
            <a class="navbar-brand" href="/data/index.php">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <?php elseif ($_SESSION["role_id"] != 2) : ?>
                        <a href="dashboard.php" class="navbar-brand" style="font-style: italic;">Dashboard</a>
    ...
    <div class="container-fluid">
        <div class="row ">
            <div class="col-md-3" id="gambar-me">
                <img src="img/me.jpg" alt="" width="auto" height="100px" style="border-radius: 50%;">
                ...
                <main>
                    <div class="container">
                        <div style="display: flex; justify-content: space-between; align-items: center;">
                            ...
                            <div>
                                <a class="btn btn-dark" href="/data/index.php"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-left-short" viewBox="0 0 16 16">
                        ...
                        <?php foreach ($posts as $post) : ?>
                            <div>
                                <img src="/data/posts/img/<?= $post['gambar']; ?>" alt="" width="100%" height="auto">
                                <h2 style="margin-top :20px;"><?= $post['judul']; ?></h2>
                                <p style="font-style:italic; margin-bottom:20px;">Publish by : <?= $post['create_by']; ?> / <?= (date("d F Y H:i A", strtotime($post['created_at']))); ?></p>
                                <p><?= $post['text']; ?></p>
                                <br>
                                <br>
                            </div>
                        ...
                        <?php endforeach; ?>
                        <div>
                            <h2><svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="bi bi-chat-dots-fill" viewBox="0 0 16 16">
                            ...
                            <div style="margin: 10px">
                                <form action="">
                                    ...
                                    <p class="btn btn-dark disable">Send</p>
                                    <p style="font-style:italic">Comming soon! OK.</p>
                                </form>
