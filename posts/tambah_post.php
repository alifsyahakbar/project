...
<body>
    ...
    <div class="container-fluid">
        ...
        <br>
        <p class="text-muted" style="font-style: italic;"><small class="text-danger">* </small>Jika Tags dan Category tidak ada mohon input terlebih dahulu.</p>
    </div>
    <br>
    <div class="container-fluid">
        <form action="" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-4">
                <label for="summernote">Artikel / Text</label>
            ...
            <div class="mb-4">
                ...
                <small class="text-muted" style="font-style: italic;"><small class="text-danger">*</small> Untuk saat ini tags hanya 1 tag.</small>
