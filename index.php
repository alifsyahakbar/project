...
$halaman = mysqli_query($conn, "SELECT * FROM posts LIMIT $awalData, $jumlahDataPerhalaman");
...
<head>
  ...
  <title>Home | SyahriProject</title>
  ...
  <div class="container-fluid">
    <div class="row ">
      ...
      <div class="col-md-6">
        <main>
          <div class="container">
            <h1 style="margin-top: 10px ;">Recent Posts</h1>
            <hr>
              ...
              <?php foreach ($halaman as $post) : ?>
                <?php if ($post["status"] == 'publish') : ?>
                  <div style="padding: 10px;">
                    ...
                    <img src="/data/posts/img/<?= $post["gambar"]; ?>" alt="" height="auto" width="75%">
                    <p style="font-style:italic; margin:10px;">Publish by : <?= $post['create_by']; ?> / <?= (date("d F Y, H:i A", strtotime($post['created_at']))); ?></p>
                    <p><?= substr($post['text'], 0, 200) . "..."; ?></p>
                    <a href="/data/view-post.php?slug=<?= $post["slug"]; ?>" class="btn btn-dark">Read More</a>
                  </div>
                  <br>
                  <br>
            ...
            <?php else : ?>
              <div style="display: block; text-align: center; margin: 20px; padding: 10px;">
                <img src="/data/img/notfound.png" alt="" height="auto" width="70%" style="align-items: center;">
              </div>
            <?php endif; ?>
          </div>
    ...
    <?php if (isset($error)) : ?>
      <div style="display: block; text-align: center; margin: 20px; padding: 10px;">
        <img src="/data/img/notfound.png" alt="" height="auto" width="50%" style="align-items: center;">
      </div>
    <?php endif; ?>
    <!-- end error -->
  </div>
